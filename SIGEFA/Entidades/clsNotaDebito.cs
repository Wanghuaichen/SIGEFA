...
{
    public class clsNotaDebito
    {
        #region propiedades

        private String iCodNotaDebito;
        private Int32 iCodNotaDebitoNueva;
        private String sDocumentoNotaDebito;
        ...
        public String CodNotaDebito
        {
            get { return iCodNotaDebito; }
            set { iCodNotaDebito = value; }
        }

        public string DocumentoNotaDebito
        {
            get { return sDocumentoNotaDebito; }
            set { sDocumentoNotaDebito = value; }
        }

        public int CodNotaDebitoNueva
        {
            get { return iCodNotaDebitoNueva; }
            set { iCodNotaDebitoNueva = value; }
        }
