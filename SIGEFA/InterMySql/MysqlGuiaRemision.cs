    ...
    class MysqlGuiaRemision: IGuiaRemision
    {
        ...
        public Boolean insert(clsGuiaRemision GuiaRemision)
        {
            try
            {
                ...
                if (GuiaRemision.CodTransferencia != 0) { oParam = cmd.Parameters.AddWithValue("codtra", GuiaRemision.CodTransferencia); } else { oParam = cmd.Parameters.AddWithValue("codtra", null); }
                ...
                if (GuiaRemision.CodProveedor == 0) oParam = cmd.Parameters.AddWithValue("codprov", null);
                else oParam = cmd.Parameters.AddWithValue("codprov", GuiaRemision.CodProveedor);
        ...
        public Boolean insertrelacionguia(Int32 codguia, Int32 codventa, Int32 codalmacen, Int32 codusuario, Int32 CodTrans)
        {
            try
            {
                con.conectarBD();
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        GuiaRemision.CodProveedor = dr.GetInt32(41);
