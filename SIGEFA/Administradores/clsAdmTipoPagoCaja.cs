...
{
    class clsAdmTipoPagoCaja
    {
        ITipoPagoCaja MTPcaja = new MysqlTipoPagoCaja();

        public Boolean insert(clsTipoPagoCaja Codigo)
        {
            try
            {
                return MTPcaja.Insert(Codigo);
            }
            catch (Exception ex)
            {
        ...
        public Boolean update(clsTipoPagoCaja Codigo)
        {
            try
            {
                return MTPcaja.Update(Codigo);
            }
            catch (Exception ex)
            {
        ...
        public DataTable ListaTipoPagoCaja()
        {
            try
            {
                return MTPcaja.ListaTipoPagoCaja();
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
