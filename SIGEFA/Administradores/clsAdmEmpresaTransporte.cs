...
{
    class clsAdmEmpresaTransporte
    {
        IEmpresaTranporte Memp = new MysqlEmpresaTranporte();
        ...
        public Boolean delete(Int32 Codemp)
        {
            try
            {
        ...
        public clsEmpresaTransporte MuestraEmpresaTranporte(Int32 CodEmpresaTranporte)
        {
            try
            {
