...
{
    class clsAdmVehiculoTransporte
    {
        IVehiculoTransporte Mveh = new MysqlVehiculoTransporte();
        ...
        public Boolean delete(Int32 Codveh)
        {
            try
            {
        ...
        public clsVehiculoTransporte MuestraVehiculoTransporte(Int32 CodVehiculoTransporte)
        {
            try
            {
