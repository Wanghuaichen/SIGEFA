...
{
    class clsAdmFormaPago
    {
        IFormaPago Mpago = new MysqlFormaPago();
        ...
        public Boolean delete(Int32 Codpago)
        {
            try
            {
                return Mpago.Delete(Codpago);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public DataTable MuestraFormaPagos()
        {
            try
            {
                return Mpago.ListaFormaPagos();
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public clsFormaPago CargaFormaPago(Int32 Codigo)
        {
            try
            {
                return Mpago.CargaFormaPago(Codigo);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public clsFormaPago BuscaFormaPago(String Codigo)
        {
            try
            {
                return Mpago.BuscaFormaPago(Codigo);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public DataTable CargaFormaPagos(Int32 tip)
        {
            try
            {
                return Mpago.CargaFormaPagos(tip);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public DataTable CargaFormaPagosReporte()
        {
            try
            {
                return Mpago.CargaFormaPagosReportes();
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public clsFormaPago BuscaFormaPagoVenta(Int32 Codigo)
        {
            try
            {
                return Mpago.BuscaFormaPagoVenta(Codigo);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public DataTable CargaFormaPagosCuotas()
        {
            try
            {
                return Mpago.CargaFormaPagosCuotas();
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
