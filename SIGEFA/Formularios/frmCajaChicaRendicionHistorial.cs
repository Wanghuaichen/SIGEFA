...
{
    public partial class frmCajaChicaRendicionHistorial : DevComponents.DotNetBar.Office2007Form
    {        
        ...
        public frmCajaChicaRendicionHistorial()
        {
            InitializeComponent();
        }
        ...
        private void ListaRendiciones()
        {
            ...
            //data.DataSource = AdmCaja.ListaRendiciones(frmLogin.iCodAlmacen,0);
