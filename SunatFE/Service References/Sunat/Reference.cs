...
namespace SunatFE.Sunat {
    ...
    public interface billService {
        ...
        SunatFE.Sunat.getStatusResponse getStatus(SunatFE.Sunat.getStatusRequest request);
        ...
        SunatFE.Sunat.sendBillResponse sendBill(SunatFE.Sunat.sendBillRequest request);
        ...
        SunatFE.Sunat.sendPackResponse sendPack(SunatFE.Sunat.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        SunatFE.Sunat.sendSummaryResponse sendSummary(SunatFE.Sunat.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public SunatFE.Sunat.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(SunatFE.Sunat.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : SunatFE.Sunat.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<SunatFE.Sunat.billService>, SunatFE.Sunat.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SunatFE.Sunat.getStatusResponse SunatFE.Sunat.billService.getStatus(SunatFE.Sunat.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public SunatFE.Sunat.statusResponse getStatus(string ticket) {
            SunatFE.Sunat.getStatusRequest inValue = new SunatFE.Sunat.getStatusRequest();
            inValue.ticket = ticket;
            SunatFE.Sunat.getStatusResponse retVal = ((SunatFE.Sunat.billService)(this)).getStatus(inValue);
