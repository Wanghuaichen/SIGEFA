...
namespace SunatFE
{
    public class DebitNote : IXmlSerializable
    {
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(RequestedMonetaryTotal.PayableAmount.value.ToString(Constantes.FormatoNumerico));
            writer.WriteEndElement();
            ...
            foreach (var line in DebitNoteLines)
            {
                ...
                writer.WriteStartElement("cbc:DebitedQuantity");
                {
                    ...
                    writer.WriteValue(line.DebitedQuantity.Value.ToString(Constantes.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                writer.WriteStartElement("cbc:LineExtensionAmount");
                {
                    ...
                    writer.WriteValue(line.LineExtensionAmount.value.ToString(Constantes.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                if (line.AllowanceCharge.ChargeIndicator)
                {
                    ...
                    writer.WriteValue(line.AllowanceCharge.Amount.value.ToString(Constantes.FormatoNumerico));
                    writer.WriteEndElement();
                    #endregion
                ...
                writer.WriteString(line.Price.PriceAmount.value.ToString(Constantes.FormatoNumerico));
                writer.WriteEndElement();
